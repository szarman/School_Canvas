<#
  Registers a Windows scheduled task that runs run_daily.py at 11:00 PM.

  Usage:
      powershell -ExecutionPolicy Bypass -File .\install_task.ps1
      powershell -ExecutionPolicy Bypass -File .\install_task.ps1 -At 22:30
  ...
  next login if the machine was off at 11 PM.
#>
...
# pythonw.exe runs without popping a console window at 11 PM.
